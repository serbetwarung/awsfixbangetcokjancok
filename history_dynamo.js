...
async function loadHistory() {
    try {
        console.log('Fetching history from DynamoDB...');
    ...
    try {
        ...
        history.forEach((item) => {
            ...
            historyItem.innerHTML = `
                ...
                <button class="btn btn-danger btn-sm delete-btn" onclick="deleteHistoryItem('${item.timestamp}')">
...
async function deleteHistoryItem(timestamp) {
    try {
        ...
        const response = await fetch(`${API_ENDPOINT}/history?userId=${userId}&timestamp=${timestamp}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
